...
public class AdaptadorRespuestasHilo extends BaseAdapter {
    private List<HiloForo> listaForo;
    private Context context;
    private String idioma;

    public AdaptadorRespuestasHilo(List<HiloForo> listaForo, Context context, String idioma) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvTituloForo.setVisibility(View.GONE);
